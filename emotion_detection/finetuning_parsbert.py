...
if __name__ == '__main__':
    logging.basicConfig(filename=f'/Users/arshiayousefi/Desktop/ML/armanemo/assets/logs/ParsBert_model.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
    ...
    model = TextClassificationParsBert(bertcofig, config.parsbert_pretrained_model)
